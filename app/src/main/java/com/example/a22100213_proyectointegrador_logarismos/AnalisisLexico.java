...
public class AnalisisLexico {
    ...
    static {
        ...
        // sin precedencia (marcadores de sistema)
    ...
    private static void lexFromList(List<Token> list, List<LexToken> out) {
        ...
        while (i < list.size()) {
            ...
            // d/d_?  -> DERIV con variable opcional
    ...
    private static void lexFromContainer(Token t, List<LexToken> out) {
        switch (t.value) {
            case "\\exp":
                ...
                if (!t.children.isEmpty()) lexFromList(t.children, out);
                break;
